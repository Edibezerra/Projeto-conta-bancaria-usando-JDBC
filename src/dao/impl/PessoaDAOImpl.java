...
public class PessoaDAOImpl implements PessoaDAO {
	...
	public void salvar(Pessoa pessoa) {
		...
		String sql = "INSERT INTO PESSOA( NOME, CPF, SEXO, IDADE, ID_ENDERECO, NUMERO_CONTA) " + "VALUES(?, ?, ?, ?, ?, ?)";
	...
	public void alterar(Pessoa pessoa) {
		...
		String sql = "UPDATE PESSOA SET NOME = ? , SEXO = ?, IDADE = ?, ID_ENDERECO = ?," + " NUMERO_CONTA = ? WHERE CPF = ?";
